...
console.log("Hello, My name is Connor McElwain");
console.log("This is a '\single quoted statement\' and this is a \"double quoted statement\" ||")
// #5a
console.log("1 plus 1 equals " + (1 + 1));
console.log("2 plus 2 equals " + (2 + 2));
console.log("56 divided by 7 equals " + (56/7));
console.log("42.6 times 18.3 equals " + (42.6 * 18.3));
console.log("83.97 minus 34.86 " + (83.97 - 34.86));
console.log("5 + 4 + 3/2 * 6 - 1 " + "The answer is " + (5 + 4 + 3 / 2 * 6 - 1));
console.log("29 * 75 + 32/8 " + "The answer is " + (29 * 75 + 32 / 8));
console.log("((42 + 89)*3)/(72 - 36) " + "The answer is " + ((42 + 89)* 3)/(72 - 36));
console.log("4 % 3 " + "The answer is " + (4 % 3));
console.log("$33.00 - $15.87 " + "The answer is " + "$" + (33.00 - 15.87));
// #7a
console.log("The type of '23' is:" + typeof(23));
